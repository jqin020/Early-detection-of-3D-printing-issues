...
class ParametersDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_name = os.path.join(self.root_dir, f'dataset/images/{self.dataframe.img_path[idx]}')
        ...
        if self.has_under_extrusion:
            extrusion_class = int(self.dataframe.has_under_extrusion[idx])
